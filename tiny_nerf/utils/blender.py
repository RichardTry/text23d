...
def _subsample_frames(frames, max_num_frames):
    return random.sample(frames, k=max_num_frames)


class BlenderDataset(Dataset):
    def __init__(self, root_dir, split="train", img_wh=(800, 800), max_frames=None):
    ...
    def read_meta(self):
        ...
        if self.split == "train":  # create buffer of all rays and rgb data
            ...
            frames_gen = (
                ...
                else _subsample_frames(self.meta["frames"], self.max_frames)
            )
